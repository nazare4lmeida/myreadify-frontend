...
// REMOVER: A importação dinâmica de imagens do Vite (import.meta.glob) não é mais necessária aqui
...
  // REMOVER: A função inteligente para resolver a URL da imagem não é mais necessária aqui
...
                <img 
                  // Usa a nova função para obter a URL correta, passando o objeto book
                  src={getImageUrl(summary.book)} 
