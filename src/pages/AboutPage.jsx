  ...
  return (
    <div className="about-page">
      ...
      <div className="about-content">
        ...
        <ul>
          <li>Adicionar, atualizar e remover livros da sua estante pessoal.</li>
          <li>Pesquisar obras pelo seu autor favorito.</li>
          <li>Marcar aqueles livros que tocaram seu coração como favoritos.</li>
          <li>Fazer o download de obras em domínio público nos formatos mais populares, como EPUB e MOBI.</li>
        </ul>
        <p>
